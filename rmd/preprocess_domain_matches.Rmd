...
ips_domains_ipr_ens99 = read.delim(ips_domains_ipr_ens99_name)
...
```{r, include=T}
humantfs_dbd_ids = as.character(read.delim(humantfs_dbd_ids_name)$x)
ips_domains_ipr_ens99_iprs = as.character(read.delim(ips_domains_ipr_ens99_iprs_name)$x)
```
