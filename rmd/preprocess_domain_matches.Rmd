...
ips_domains_ipr_ens99 = args[9]
ipr_hierarchy_yaml_name = args[10]
humantfs_dbd_ids_name = args[11]
ips_domains_ipr_ens99_iprs_name = args[12]
dbd_ipr_humantfs_name = args[13]
ensg_enst_ensp_name = args[14]
...
```{r, include=T}
humantfs_dbd_ids = read.delim(humantfs_dbd_ids_name)
ips_domains_ipr_ens99_iprs = read.delim(ips_domains_ipr_ens99_iprs_name)
```
...
```{r, include=T}
dbd_ipr_humantfs = read.delim(dbd_ipr_humantfs_name)
